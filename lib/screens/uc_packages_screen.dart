  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CupertinoNavigationBar(
        ...
        middle: const Text('BGMI UC', style: TextStyle(fontWeight: FontWeight.w600)),
                      ...
                      child: Column(
                        ...
                        children: [
                                    ...
                                    children: [
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Text('UC', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: primaryColor)),
                                                ),
                                              ],
                                            ),
                                      ...
                                      if (isSelected)
                                        Positioned(
                                          top: 10,
                                          right: 10,
                                          child: Icon(CupertinoIcons.checkmark_alt_circle_fill, color: primaryColor, size: 20),
                                        ),
                                    ],
                                  ),
                                ),
                          ...
                          Container(
                            padding: const EdgeInsets.all(16),
                            decoration: BoxDecoration(
                              color: isDark ? Colors.orange.withOpacity(0.1) : Colors.amber.shade50,
                              borderRadius: BorderRadius.circular(16),
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Icon(CupertinoIcons.info_circle_fill, color: Colors.orange.shade600, size: 20),
                                const SizedBox(width: 12),
                                Expanded(
                                  child: Text(
                                    'Note: If QR code fails for payments above ₹2000, please add money to your wallet multiple times and pay via wallet balance.',
